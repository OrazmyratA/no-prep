...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  getBookStorageLocation: () => ipcRenderer.invoke('books:get-storage-location'),
  chooseBookStorageLocation: () => ipcRenderer.invoke('books:choose-storage-location'),
  useDefaultBookStorageLocation: () => ipcRenderer.invoke('books:use-default-storage-location'),
  openBookStorageLocation: () => ipcRenderer.invoke('books:open-storage-location'),
  ...
  aiSpeakingSaveApiKey: (input) => ipcRenderer.invoke('ai-speaking:save-api-key', input ?? {}),
  aiSpeakingClearApiKey: () => ipcRenderer.invoke('ai-speaking:clear-api-key'),
  ...
  aiSpeakingGenerateClosingFeedback: (input) => ipcRenderer.invoke('ai-speaking:generate-closing-feedback', input ?? {}),
