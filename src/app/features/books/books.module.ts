...
@NgModule({
  declarations: [BookCreatorComponent, BookReaderComponent, BookReaderPageDrawerComponent, BookReaderSpeakingPanelComponent, BookSwitcherComponent, PdfPageCanvasComponent],
