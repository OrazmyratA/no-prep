...
export class BookReaderAnnotationController {
  ...
  private readonly historyController: BookReaderAnnotationHistoryController;
  ...
  constructor(private readonly reader: any) {
    ...
    this.historyController = new BookReaderAnnotationHistoryController(this, this.reader);
  }
  ...
  canUndoAnnotation(): boolean {
    return this.historyController.canUndoAnnotation();
  }

  canRedoAnnotation(): boolean {
    return this.historyController.canRedoAnnotation();
  }

  canClearPageAnnotations(): boolean {
    return this.historyController.canClearPageAnnotations();
  }

  undoAnnotation(): void {
    this.historyController.undoAnnotation();
  }

  redoAnnotation(): void {
    this.historyController.redoAnnotation();
  }

  clearPageAnnotations(): void {
    this.historyController.clearPageAnnotations();
  }
  ...
  pushUndoAction(action: ReaderAnnotationAction): void {
    this.historyController.pushUndoAction(action);
  }
